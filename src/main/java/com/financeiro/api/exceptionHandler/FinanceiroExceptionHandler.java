...
public class FinanceiroExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String messagemUsuario = messageSoucer.getMessage("mensagem.invalida", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<Object> handleEmptyResultDataAccessException(EmptyResultDataAccessException ex,
			WebRequest request) {
		String messagemUsuario = messageSoucer.getMessage("recurso.nao-encontrado", null, LocaleContextHolder.getLocale());
	...
	public ResponseEntity<Object> handlePessoaInexistenteOuInativaException(PessoaInexistenteOuInativaException ex){
		String messagemUsuario = messageSoucer.getMessage("recurso.inexistente-ou-inativo", null, LocaleContextHolder.getLocale());
		String messagemDesenvolvedor = ex.toString();
		List<Erro> erros = Arrays.asList(new Erro(messagemUsuario, messagemDesenvolvedor));
	...
	private List<Erro> criarListaDeErros(BindingResult bindingResult) {
		...
		for (FieldError fieldError : bindingResult.getFieldErrors()) {
			String messagemUsuario = messageSoucer.getMessage(fieldError, LocaleContextHolder.getLocale());
